...
//#define PAGE_WRITE_DIS
//#define CALCULATE_PAGE_TIME
//#define CALCULATE_COPY_TIME//#define BLOCK_WRITE_DIS
//#define NAND_PAGE_COMPARE_DUMP//打印对比时不时0xff的数据
...
#define NAND_RB1  GET_PIN(D, 6)
#define NAND_RB rt_pin_read(NAND_RB1)

#define NAND_ADDRESS			0X70000000	//nand flash的访问地址,接NCE3,地址为:0X8000 0000
#define NAND_CMD				CMD_AREA   //1<<16		//发送命令
#define NAND_ADDR				ADDR_AREA		//发送地址
...
#define MX30LF4G         0XDC909556  //MT29F16G08ABABA
 
extern NAND_HandleTypeDef NAND_Handler;
rt_err_t rt_mtd_nand_register_device(const char                *name,
                                     struct rt_mtd_nand_device *device);

u32 NAND_ReadID(void);
u8 FSMC_NAND_ReadPage(u8 *_pBuffer, u32 _ulPageNo, u16 _usAddrInPage, u16 NumByteToRead);
u8 FSMC_NAND_WritePage(u8 *_pBuffer, u32 _ulPageNo, u16 _usAddrInPage, u16 NumByteToRead);
