...
//    {0x1,  USB_EP_ATTR_BULK,        USB_DIR_IN,     64, ID_UNASSIGNED},//USB_EP_ATTR_INT //msc
//    {0x1,  USB_EP_ATTR_BULK,        USB_DIR_OUT,    64, ID_UNASSIGNED},
//    {0x2,  USB_EP_ATTR_INT,         USB_DIR_IN,     64, ID_UNASSIGNED},//uart
...
void HAL_PCD_DataInStageCallback(PCD_HandleTypeDef *hpcd, uint8_t epnum)
{
    ...
    else
    {
      ...
      //  rt_kprintf("usbd_ep_in_handler epnum:%x, xfer_count:%x\n",0x80 | epnum, hpcd->IN_ep[epnum].xfer_count);
...
static rt_err_t _open(rt_device_t device)
...
{   GPIO_InitTypeDef GPIO_InitStruct = {0};
    ...
    GPIO_InitStruct.Mode =GPIO_MODE_INPUT ;//GPIO_MODE_INPUTGPIO_NOPULL
...
//	while(1);
    ...
    _stm_udc.parent.open = _open;
    _stm_udc.parent.close = _close;
#endif
