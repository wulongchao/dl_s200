...
/* ------------------ PM oscillator start ------------------ */
/* STM32F7 */
#define OSC_CONF_SYS_FREQ_OD        216U    /* Max system clock with over-drive mode  MHz */
#define OSC_CONF_SYS_FREQ_MAX       180U    /* Max system clock  MHz */
#define OSC_CONF_SYS_FREQ_NORMAL    168U    /* Normal system clock  MHz */
#define OSC_CONF_PCLK1_FREQ_MAX     54U     /* Max PCLK1  MHz */
#define OSC_CONF_PCLK2_FREQ_MAX     108U    /* Max PCLK2  MHz */

#define OSC_CONF_PLL_SYS_FREQ_MIN   24U     /* Min system clock with pll on  MHz */
#define OSC_CONF_PLL_VCO_FREQ_MIN   192U    /* Min pll vco frequency  MHz */
...
#define PM_POW_VOLT_SCALE_NUMS      3U
  ...
  #define FLASH_LATENCY_MAX_NUMS    9U
  #define FLASH_LATENCY_FREQ        24U     /* FLASH_LATENCY increasing frequency  MHz */
#elif defined(RT_PM_USING_VDD_2P1_2P4)
  #define FLASH_LATENCY_MAX_NUMS    10U
  #define FLASH_LATENCY_FREQ        22U     /* FLASH_LATENCY increasing frequency  MHz */
#else
  #define FLASH_LATENCY_MAX_NUMS    9U
  #define FLASH_LATENCY_FREQ        20U     /* FLASH_LATENCY increasing frequency  MHz */
#endif
...
{
    {PWR_REGULATOR_VOLTAGE_SCALE3, 144U},
    {PWR_REGULATOR_VOLTAGE_SCALE2, 168U},
    {PWR_REGULATOR_VOLTAGE_SCALE1, 180U},
};
